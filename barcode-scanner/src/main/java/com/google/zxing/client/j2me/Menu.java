...
/**
 * The Menu form simply adds Command Listener functionality to the standard List User Interface component.
 * 
...
final class Menu extends List implements CommandListener {
	 ...
	 * 
	 * @param parent
	 *            The Parent ZXing MIDlet.
	 * @param title
	 *            The title of the List.
	 * @param item
	 *            The caption of the item action Command.
	 */
	 ...
	 * 
	 * @return The selected option represented as a String. If no option is selected, then the empty string is returned.
	 */
	...
	/**
	 * A convenience method for removing all items from the list. While the size of the list does not equal zero, the
	 * first item of the list is deleted.
	 */
	public void clear() {
	...
	/**
	 * CommandListener Required Implementation for capturing soft key presses. This is where all call back methods (of
	 * the MIDlet) are serviced.
	 * 
	 * @param command
	 *            The command requiring attention.
	 * @param displayable
	 *            The Display.
	 */
